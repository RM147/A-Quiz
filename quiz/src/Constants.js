...
export const gen7 = 810;

export const randomExpl = "This mode will ask you about individual Pokemon. The Pokemon will be randomly pulled out from the selected range e.g. gen 1. You can keep answering questions endlessly or choose a limited number of questions and get a score. If you're feeling hardcore, try just National Dex numbers with no pictures.";
